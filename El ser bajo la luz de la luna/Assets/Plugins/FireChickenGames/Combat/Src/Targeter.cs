namespace FireChickenGames.Combat
{
    ...
    public class Targeter : MonoBehaviour
    {
        ...
        [Tooltip("The amount of horrizontal movement it takes to deselect an aim assist target.")]
        [Range(0f, 5f)]
        ...
        void AimAtTarget(ProximityTarget proximityTarget)
        {
            ...
            {
                // Start Aiming
                characterShooter.StartAiming(aimingAtTarget);
                // Disable crosshair while aiming at target.
                characterShooter.DestroyCrosshair();
            }
        }
