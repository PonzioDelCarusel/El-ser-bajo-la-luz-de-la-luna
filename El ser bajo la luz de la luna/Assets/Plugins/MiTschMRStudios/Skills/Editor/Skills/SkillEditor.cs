namespace MiTschMR.Skills
{
    ...
    public class SkillEditor : Editor
    {
        ...
        public void OnDestroySkill()
        {
            ...
            IActionsList list1 = (IActionsList)this.spActionsOnActivate.objectReferenceValue;
            IActionsList list2 = (IActionsList)this.spActionsOnCast.objectReferenceValue;
            IActionsList list3 = (IActionsList)this.spActionsOnExecute.objectReferenceValue;
            IActionsList list4 = (IActionsList)this.spActionsOnFinish.objectReferenceValue;
            IConditionsList list5 = (IConditionsList)this.spConditionsRequirements.objectReferenceValue;
            IActionsList list6 = (IActionsList)this.spActionsOnReset.objectReferenceValue;
        ...
        private void PaintSectionSkillSettings()
        {
            ...
            using (var group = new EditorGUILayout.FadeGroupScope(this.sectionSkillSettings.state.faded))
            {
                if (group.visible)
                {
                    ...
                    if (spSkillExecutionType.enumValueIndex == 1) EditorGUILayout.PropertyField(this.spCastTime);
                    if (spSkillExecutionType.enumValueIndex != 2) EditorGUILayout.PropertyField(this.spExecutionTime);
                    if (spSkillExecutionType.enumValueIndex != 2) EditorGUILayout.PropertyField(this.spCooldownTime);
