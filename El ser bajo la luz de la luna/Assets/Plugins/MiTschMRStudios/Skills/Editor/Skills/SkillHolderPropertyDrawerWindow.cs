namespace MiTschMR.Skills
{
	...
	public class SkillHolderPropertyDrawerWindow : PopupWindowContent
	{
		...
		public SkillHolderPropertyDrawerWindow(Rect activatorRect, SerializedProperty property)
		{
		...
		protected virtual void PaintSuggestions(ref string modifiedText)
		{
			...
			if (suggestionCount > 0)
			{
				...
				{
					Skill skill = DATABASE_SKILLS.GetSkillListSkillByIndex(this.suggestions[i]);
