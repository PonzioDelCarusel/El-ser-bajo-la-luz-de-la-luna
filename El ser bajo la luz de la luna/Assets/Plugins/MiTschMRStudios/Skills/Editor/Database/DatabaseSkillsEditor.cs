namespace MiTschMR.Skills
{
	...
	public class DatabaseSkillsEditor : IDatabaseEditor
	{
		...
		protected string versionSkills;
		protected string versionSkillsExamples;
		...
		protected virtual void OnEnable()
		{
			...
			this.versionSkills = ModuleManager.GetAssetModule("com.mitschmr-studios.module.skills").module.version.ToString();
			this.versionSkillsExamples = ModuleManager.GetAssetModule("com.mitschmr-studios.examples.skills").module.version.ToString();
